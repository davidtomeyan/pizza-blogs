...
export const colors = {
  text: {
    'text-red': {
      css: { 'color': `light-dark(${tailwindColors.red[400]}, ${tailwindColors.red[400]})` },
      label: 'Red',
    },
    'text-orange': {
    ...
    'text-green': {
      css: { 'color': `light-dark(${tailwindColors.green[700]}, ${tailwindColors.green[700]})` },
      label: 'Green',
    },
    'text-lime': {
      css: { 'color': `light-dark(${tailwindColors.lime[800]}, ${tailwindColors.lime[800]})` },
      label: 'Lime',
    },
    'text-blue': {
    ...
    'text-gray': {
      css: { 'color': `light-dark(${tailwindColors.gray[600]}, ${tailwindColors.gray[400]})` },
      label: 'Gray',
    },
  ...
  underline: {
    ...
    'underline-gray': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.gray[600]}, ${tailwindColors.gray[400]})`,
      },
      label: 'Gray',
    },
    'underline-lime': {
      css: {
        'text-decoration': 'underline',
        'text-underline-offset': '4px',
        'text-decoration-color': `light-dark(${tailwindColors.lime[700]}, ${tailwindColors.lime[700]})`,
      },
      label: 'Lime',
    },
    'underline-blue': {
