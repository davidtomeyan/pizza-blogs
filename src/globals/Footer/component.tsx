      ...
      <div
        ...
        <div
          ...
          <div
            ...
            <Logo className="mx-auto object-center lg:mx-0 lg:object-left max-h-18 w-full"/>
          </div>
          <div
            className={cn([
          ...
          <div
              className={cn([
                'flex-1 flex justify-center flex-col-reverse lg:flex-row  lg:justify-end gap-y-12',
              ])}>
            <div
                className={cn([
                  'flex items-center justify-center flex-1 px-2 lg:justify-end',
                ])}>
